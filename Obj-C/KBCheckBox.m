...
#import "KBCheckBox.h"
#import "KBAnimationManager.h"
#import "KBPathManager.h"
...
/** The KBAnimationManager object used to generate animations.
 */
@property (strong, nonatomic) KBAnimationManager *animationManager;

/** The KBPathManager object used to generate paths.
 */
@property (strong, nonatomic) KBPathManager *pathManager;
...
- (void)commonInit {
    ...
    _onAnimationType = KBAnimationTypeStroke;
    _offAnimationType = KBAnimationTypeStroke;
...
- (void)initPathManager {
    _pathManager = [KBPathManager new];
    _pathManager.lineWidth = _lineWidth;
    _pathManager.boxType = _boxType;
}

- (void)initAnimationManager {
    _animationManager = [[KBAnimationManager alloc] initWithAnimationDuration:_animationDuration];
}
...
- (void)setBoxType:(KBBoxType)boxType {
    _boxType = boxType;
...
- (void)setOffAnimationType:(KBAnimationType)offAnimationType {
...
- (void)addOnAnimation {
    ...
    switch (self.onAnimationType) {
        ...
        case KBAnimationTypeBounce: {
            CGFloat amplitude = (self.boxType == KBBoxTypeSquare) ? 0.20 : 0.35;
