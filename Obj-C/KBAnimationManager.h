...
/** Animation object used by KBCheckBox to generate animations.
 */
@interface KBAnimationManager : NSObject

/** The duration of the animation created by the KBAnimationManager object.
 */
@property (nonatomic) CGFloat animationDuration;

/** Designated initializer.
 * @param animationDuration The duration of the animations created with the KBAnimationManager object.
 * @return Returns the a fully initialized KBAnimationManager object.
 */
